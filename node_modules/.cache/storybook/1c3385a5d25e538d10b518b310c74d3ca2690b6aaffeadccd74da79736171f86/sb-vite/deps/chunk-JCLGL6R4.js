...
import {
  require_react
} from "./chunk-GNV2QXU2.js";
import {
  require_global
} from "./chunk-CBAC4QTP.js";
import {
  __toESM
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-J67QBPXO.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-I56B52JI.js"), act = await getAct();
...
//# sourceMappingURL=chunk-JCLGL6R4.js.map
